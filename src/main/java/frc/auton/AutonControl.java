...
import frc.auton.mode.left.Left2PanelSideCargoShipFarLevel2;
import frc.auton.mode.left.LeftFarRocketMidHighLevel2;
import frc.auton.mode.right.Right2PanelSideCargoShipFarLevel2;
import frc.auton.mode.right.RightFarRocketMidHighLevel2;
...
public class AutonControl {
    ...
    private AutonControl() {
        ...
        step1.add(new RightFarRocketMidHighLevel2());
        step1.add(new Right2PanelSideCargoShipFarLevel2());
        step1.add(new LeftFarRocketMidHighLevel2());
        step1.add(new Left2PanelSideCargoShipFarLevel2());
