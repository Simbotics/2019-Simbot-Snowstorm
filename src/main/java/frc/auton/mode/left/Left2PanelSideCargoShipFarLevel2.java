...
public class Left2PanelSideCargoShipFarLevel2 implements AutonMode {

    @Override
    public void addToMode(AutonBuilder ab) {
        ab.addCommand(new DriveSetPosition(0, 1.1, 180 - 270));
        ...
        ab.addCommand(new DriveToPoint(-2, 14.7, 180 - 265, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 1, 15000));
        ab.addCommand(new DriveToPoint(-4, 24.2, 180 - 205, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.25, 8, 65, 15000));
        ...
        ab.addCommand(new DriveToPoint(-4.2, 13.6, 180 - 280, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
        ...
        ab.addCommand(new DriveToPoint(-7.2, 6.3, 180 - 280, 14, RobotConstants.DRIVE_MAX_VELOCITY, 1.0,9, 15000));
        ...
        ab.addCommand(new DriveToPoint(-3.3, 21.2, 180 - 280, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.25, 15000));
        ab.addCommand(new DriveTurnToAngle(180 - 185, 2, 1500));
        ab.addCommand(new AutonOverride(RobotComponent.ELEVATOR));
        ab.addCommand(new ElevatorSetPosition(LiftState.PANEL_LOW, 20));
        ab.addCommand(new ElevatorHoldPosition(LiftState.PANEL_LOW));
