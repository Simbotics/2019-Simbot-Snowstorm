...
public class LeftFarRocketMidHigh implements AutonMode {

    @Override
    public void addToMode(AutonBuilder ab) {
        ab.addCommand(new DriveSetPosition(0, 0, 180 - 270));
        ...
        ab.addCommand(new DriveToPoint(-6.5, 19.5, 180 - 226, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.3, 15000));
        ...
        ab.addCommand(new DriveTurnToAngle(180 - 300, 5, 1000));
        ...
        ab.addCommand(new DriveToPoint(-7.6, 3.2, 180 - 280, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 0.5, 15000));
        ...
        ab.addCommand(new DriveToPoint(-5.4, 14.5, 180 - 260, 14, RobotConstants.DRIVE_MAX_VELOCITY, 0.5, 15000));
        ab.addCommand(new DriveToPoint(-8.0, 18.75, 180 - 233, 7, 14, 0.4, 15000));
        ab.addCommand(new AutonOverride(RobotComponent.ELEVATOR));
        ab.addCommand(new SetIntake(IntakeState.LIFTING_PANEL));
