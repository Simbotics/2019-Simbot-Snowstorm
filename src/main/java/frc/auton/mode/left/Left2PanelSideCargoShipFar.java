...
public class Left2PanelSideCargoShipFar implements AutonMode {

    @Override
    public void addToMode(AutonBuilder ab) {
        ab.addCommand(new DriveSetPosition(0, 3, 180 - 270));
        ab.addCommand(new SetClimberState(ClimberState.DRIVING, 20));
        
        ab.addCommand(new SetIntake(IntakeState.HAS_PANEL));
        ab.addCommand(new DriveToPoint(0.0, 5.75, 180 - 270, 9, 9, 1.0, 15000));
        ab.addCommand(new DriveToPoint(-0.71, 14.7, 180 - 265, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 1, 15000));
        ab.addCommand(new DriveToPoint(-3.25, 23.4, 180 - 205, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.25, 8, 15000));
        ...
        ab.addCommand(new DriveTurnToAngle(180 - 180, 5, 1500));
        ab.addCommand(new DriveToVisionTarget(14, 10, 0.1, 15000));
        ab.addCommand(new DriveWait());
        ab.addCommand(new SetIntake(IntakeState.OUTTAKE_PANEL));
        ab.addCommand(new IntakeWait());

        ab.addCommand(new DriveToPoint(-5.0, 22.0, 180 - 180, 3, 14, 1.0, 15000));
        ab.addCommand(new DriveToPoint(-3.9, 13.6, 180 - 280, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
        ...
        ab.addCommand(new DriveToPoint(-6.7, 6.3, 180 - 280, 14, RobotConstants.DRIVE_MAX_VELOCITY, 1.0,9, 15000));
        ...
        ab.addCommand(new DriveToPoint(-2.7, 20.2, 180 - 280, 2, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
        ...
        ab.addCommand(new SetIntake(IntakeState.OUTTAKE_PANEL));
        ab.addCommand(new IntakeWait());
        ab.addCommand(new DriveSetOutput(-0.4, 0));
