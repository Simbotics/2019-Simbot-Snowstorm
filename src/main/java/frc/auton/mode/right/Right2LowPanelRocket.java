...
public class Right2LowPanelRocket implements AutonMode {

    public void addToMode(AutonBuilder ab) {
        ab.addCommand(new DriveSetPosition(0, 0, 53.7));
        ab.addCommand(new SetClimberState(ClimberState.DRIVING, 20));

        ab.addCommand(new SetIntake(IntakeState.HAS_PANEL));
        ab.addCommand(new DriveToPoint(2.77, 4.136, 57, 5.5, 5.5,1.0, 15000));
        ...
        ab.addCommand(new DriveToPoint(6.9, 6.8, 59.45, 1, 7, 1, 15000));
        ...
        ab.addCommand(new DriveToPoint(4.0, 9.1, 27.45, 2, 8, 0.5, 15000));
       
       
        ab.addCommand(new DriveToPoint(8.0, 0.5, -90, 0.5, 10, 0.5, 15, 15000));
        ...
        ab.addCommand(new DriveToPoint(5.0, 15.6, -90, 6, 12, 0.5, 15000));
        ab.addCommand(new DriveToPoint(7.0, 18.5, -119.5, 0, 6, 0.5, 15000));
        ab.addCommand(new DriveTurnToAngle(-58, 3, 1500));
        ab.addCommand(new DriveToVisionTarget(15000));
        ab.addCommand(new DriveWait());
        ab.addCommand(new SetIntake(IntakeState.OUTTAKE_PANEL));
        ab.addCommand(new IntakeWait());
