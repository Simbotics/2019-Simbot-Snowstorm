...
public class RightLevel2FrontSideCargoShip implements AutonMode {
    ...
    public void addToMode(AutonBuilder ab) {
        ...
        ab.addCommand(new DriveToPoint(0, 7.2, 90, 7, 7, 0.5, 15000));
        ab.addCommand(new DriveToPoint(-2.0, 11.9, 90, 7, 7, 0.1, 25, 15000));
        ...
        ab.addCommand(new DriveToPoint(-2.06, 13.23, 95, 7, 7, 0.1, 20, 15000));
        ab.addCommand(new DriveToPoint(8.0, 4.64, -90, 14, RobotConstants.DRIVE_MAX_VELOCITY, 0.5, 10, 15000));
        ...
        ab.addCommand(new DriveToPoint(1.85, 23.3, -76, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.25, 15000));
        ab.addCommand(new DriveTurnToAngle(-190, 2, 15000));
        ab.addCommand(new DriveToVisionTarget(15000));
        ab.addCommand(new DriveWait());
        ab.addCommand(new SetIntake(IntakeState.OUTTAKE_PANEL));
        ab.addCommand(new IntakeWait());
        ab.addCommand(new DriveToPoint(1.85, 22.75, -199, 1, 3, 0.05, 15000));
        ab.addCommand(new DriveToPoint(5, 3, -80, 0, 14, 0.5, 15000));
