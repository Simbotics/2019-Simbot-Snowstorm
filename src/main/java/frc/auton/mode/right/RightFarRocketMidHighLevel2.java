...
public class RightFarRocketMidHighLevel2 implements AutonMode {

    @Override
    public void addToMode(AutonBuilder ab) {
        ab.addCommand(new DriveSetPosition(0, -1.9, 270));
        ...
        ab.addCommand(new DriveToPoint(6.4, 20.5, 226, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.3, 15000));
        ...
        ab.addCommand(new DriveTurnToAngle(300, 3, 1000));
        ...
        ab.addCommand(new DriveToPoint(8.1, 3.2, 280, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 0.5, 15000));
        ...
        ab.addCommand(new DriveToPoint(4.25, 14.5, 260, 14, RobotConstants.DRIVE_MAX_VELOCITY, 0.5, 15000));
        ab.addCommand(new DriveToPoint(6, 20.5, 233, 7, 14, 0.4, 15000));
        ab.addCommand(new AutonOverride(RobotComponent.ELEVATOR));
        ab.addCommand(new SetIntake(IntakeState.LIFTING_PANEL));
        ab.addCommand(new DriveTurnToAngle(300, 3, 1000));
