...
public class Right2PanelSideCargoShipFar implements AutonMode {

    @Override
    public void addToMode(AutonBuilder ab) {
        ab.addCommand(new DriveSetPosition(0, 3, 270));
        ...
        ab.addCommand(new DriveToPoint(0.71, 14.7, 265, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 1, 15000));
        ab.addCommand(new DriveToPoint(3.25, 23.4, 205, 1, RobotConstants.DRIVE_MAX_VELOCITY, 0.25, 8, 65, 15000));
        ...
        ab.addCommand(new DriveToPoint(3.9, 13.6, 280, RobotConstants.DRIVE_MAX_VELOCITY, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
        ...
        ab.addCommand(new DriveToPoint(6.7, 6.3, 280, 14, RobotConstants.DRIVE_MAX_VELOCITY, 1.0,9, 15000));
        ...
        ab.addCommand(new DriveToPoint(2.7, 20.2, 280, 2, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
        ab.addCommand(new DriveTurnToAngle(180, 2, 1500));
        ab.addCommand(new AutonOverride(RobotComponent.ELEVATOR));
        ab.addCommand(new ElevatorSetPosition(LiftState.PANEL_LOW, 20));
        ab.addCommand(new ElevatorHoldPosition(LiftState.PANEL_LOW));
