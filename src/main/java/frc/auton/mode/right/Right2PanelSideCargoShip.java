 ...
 * Add your docs here.
 */
public class Right2PanelSideCargoShip implements AutonMode {
    ...
    public void addToMode(AutonBuilder ab) {
        ...
        ab.addCommand(new DriveToPoint(0.0, 6.25, 90, 7, 7, 1.0, 15000));
        ab.addCommand(new DriveToPoint(4.0, 19.2, 90, 0, 12, 1.0, 15000));
        ...
        ab.addCommand(new DriveTurnToAngle(177, 2, 1500));
        ...
        ab.addCommand(new DriveToPoint(3.0, 21.0, 207, 1, 6, 1.0, 15000));
        ab.addCommand(new DriveToPoint(3.9, 14.1, 280, RobotConstants.DRIVE_MAX_VELOCITY,
                RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
        ab.addCommand(new DriveToPoint(7.1, 5.1, 270, 7, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 9, 15000));
        ...
        ab.addCommand(new DriveToPoint(2.8, 18.5, 280, 2, RobotConstants.DRIVE_MAX_VELOCITY, 1.0, 15000));
